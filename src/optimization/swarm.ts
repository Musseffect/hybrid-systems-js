...
abstract class StochasticOptimizationProblem{
...
abstract class ContinuousOptimizationProblem{
    abstract costFunction(x:vector):number;
    abstract dfdx(x:vector):vector;
    abstract d2fdx2(x:vector):matrix;
}